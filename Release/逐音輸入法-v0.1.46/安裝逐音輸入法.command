...
# Display semantic colors only in an interactive Terminal window.
...
# Finder, iCloud Drive, and archive extraction can attach harmless metadata
# (FinderInfo/resource-fork attributes) to an otherwise intact ad-hoc-signed
# bundle. Copy outside the file-provider folder first: metadata can otherwise
# be reattached immediately after xattr removes it.
step "2/3 驗證 App 完整性"
