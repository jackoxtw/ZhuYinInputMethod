...
mkdir -p "$TMP"
$CC -std=c99 -O2 -D_POSIX_C_SOURCE=200809L -I Core Core/ZYDictionary.c Core/ZYEngine.c Tests/test_engine.c -o "$TMP/test_engine"
$CC -std=c99 -O2 -D_POSIX_C_SOURCE=200809L -I Core Core/ZYLearning.c Tests/test_learning.c -o "$TMP/test_learning"
$CC -std=c99 -O2 -D_POSIX_C_SOURCE=200809L -I Core Core/ZYDictionary.c Core/ZYEngine.c Tests/test_candidate_learning_ranking.c -o "$TMP/test_candidate_learning_ranking"
$CC -std=c99 -O2 -D_POSIX_C_SOURCE=200809L -I Core Core/ZYDictionary.c Core/ZYEngine.c Core/ZYComposer.c Tests/test_composer.c -o "$TMP/test_composer"
$CC -std=c99 -O2 -D_POSIX_C_SOURCE=200809L -I Core Core/ZYDictionary.c Core/ZYEngine.c Core/ZYComposer.c Tests/test_composer_workspace.c -o "$TMP/test_composer_workspace"
$CC -std=c99 -O2 -I Core Core/ZYConversion.c Tests/test_conversion.c -o "$TMP/test_conversion"
"$TMP/test_engine" Resources/dictionary.bin
"$TMP/test_learning" "$TMP/learning"
"$TMP/test_candidate_learning_ranking"
"$TMP/test_composer" Resources/dictionary.bin
"$TMP/test_composer_workspace" Resources/dictionary.bin
"$TMP/test_conversion" Resources/t2s.bin
