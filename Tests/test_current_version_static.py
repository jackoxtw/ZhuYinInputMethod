...
class CurrentVersionStaticTests(unittest.TestCase):
    def test_marketing_and_build_versions_are_0_1_55_build_58(self):
        ...
        self.assertIn("<string>0.1.55</string>", plist)
        self.assertIn("<string>58</string>", plist)
        self.assertIn('[@"v0.1.55"', panel)
        self.assertIn("v0.1.55 / build 58", readme)
        self.assertIn("## v0.1.55 / build 58", changelog)
        self.assertIn("逐音輸入法  v0.1.55", html)
