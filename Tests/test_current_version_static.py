...
class CurrentVersionStaticTests(unittest.TestCase):
    def test_marketing_and_build_versions_are_0_1_49_build_52(self):
        ...
        self.assertIn("<string>0.1.49</string>", plist)
        self.assertIn("<string>52</string>", plist)
        self.assertIn('[@"v0.1.49"', panel)
        self.assertIn("v0.1.49 / build 52", readme)
        self.assertIn("## v0.1.49 / build 52", changelog)
        self.assertIn("逐音輸入法  v0.1.49", html)
